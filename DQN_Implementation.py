...
class Replay_Memory:
    ...
    def __init__(self, n_features, memory_size=50000, burn_in=10000):
...
class DQN_Agent:
    ...
    def __init__(self, env, test_env, sess, render, net_type, lr, gamma, e_start, e_end, e_decay, replace_iter, memory_size, burn_in, batch_size, n_episode, test_iter, test_interval, video_dir):
        ...
        self.memory = Replay_Memory(n_features=self.env.observation_space.shape[0], memory_size=memory_size, burn_in=self.burn_in)
